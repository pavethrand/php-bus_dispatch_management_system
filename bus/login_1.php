...
<body>
	...
	//Checking is user existing in the database or not
        $query = "SELECT * FROM `dispatcher` WHERE username='$username' and password='".md5($password)."'";
		$result = mysqli_query($con,$query) or die(mysql_error());
		$rows = mysqli_num_rows($result);
        if($rows==1){
			$_SESSION['username'] = $username;
			header("Location: dispatcherindex.php"); // Redirect user to index.php
        }else{
...
<div class="menu">
            ...
            <div class="ml-3">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="login_1.php">Dispatcher</a>
                    </li>
