...
if (isset($_REQUEST['username'])){
        ...
        $query = "UPDATE dispatcher SET username='$username', email='$email', password='".md5($password)."' WHERE id=$id";
...
<div class="form">
<h2>Update information for <?php $res = mysqli_query($con,"SELECT * FROM dispatcher where id=$id");
