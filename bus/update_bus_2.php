...
if (isset($_REQUEST['busno'])){
        ...
        $query = "UPDATE buses SET busno='$busno',busname='$busname',drivername='$drivername',start_station='$start_station',end_station='$end_station',routeno='$routeno', atiming='$atiming',dtiming='$dtiming', bstatus='$bstatus' WHERE busno=$busno";
...
<input type="radio" id="i2" class="ml-3" name="status" value="Cancelled" <?php if ($bstatus == 'Cancelled') echo 'checked="checked"'; ?>" />
