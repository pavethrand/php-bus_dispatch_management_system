...
echo "<td><a href='update_bus_1.php?busno=".$row['busno']."'><button type='button' class='btn btn-warning'>Update</button></a>
	<a onClick=\"javascript: return confirm('Please confirm deletion');\" href='delete_bus1.php?busno=".$row['busno']."'><button type='button' class='btn btn-danger ml-1'>Delete</button></a></td>";
